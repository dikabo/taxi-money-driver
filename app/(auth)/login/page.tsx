...
export default function LoginPage() {
  ...
  const onSubmit: SubmitHandler<LoginFormValues> = async (values) => {
    ...
    try {
      console.log('[DRIVER LOGIN PAGE] Original phone:', values.phoneNumber);
      
      // ✅ CRITICAL: Format phone for Supabase/Twilio
      const supabasePhone = formatPhoneForSupabase(values.phoneNumber);
      console.log('[DRIVER LOGIN PAGE] Formatted phone for Supabase:', supabasePhone);
      ...
      console.log('[DRIVER LOGIN PAGE] ✅ User exists, sending OTP...');
      ...
      if (otpError) {
        console.error('[DRIVER LOGIN PAGE] ❌ Supabase OTP error:', otpError);
        throw new Error('Impossible d\'envoyer l\'OTP. Veuillez réessayer.');
      }

      console.log('[DRIVER LOGIN PAGE] ✅ OTP sent successfully');
